...
public class GaefTestContainer extends TestContainer {

    public GaefTestContainer() {
        super();
        ...
        appPropertiesFiles = Arrays.asList(
                ...
                "com/company/gaef/app.properties",
    ...
    public static class Common extends GaefTestContainer {

        public static final GaefTestContainer.Common INSTANCE = new GaefTestContainer.Common();
